...
int main(){
  ...
  */
  ...
  printf("Num bytes of prime1 is %d\n",BN_num_bytes(prime1)); /*the function BN_num_bytes is important to control the exact length of prime nuumber.
                                                                Infact it is important to notice that the generation of a prime number must overcome 
                                                                several constraints (such as safe, add, exc...) and so the length of prime number 
                                                                could be different than the expected one*/
